...
const uri = `mongodb+srv://${encodedUser}:${encodedPass}@jubaid.xspkh92.mongodb.net/?appName=Jubaid`;
// Log a masked URI for debugging (doesn't reveal password)
const maskedUri = `mongodb+srv://${encodedUser}:*****@jubaid.xspkh92.mongodb.net/?appName=Jubaid`;
